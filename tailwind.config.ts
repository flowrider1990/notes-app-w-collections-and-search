...
export default {
  ...
  theme: {
    extend: {
      // Both faces come from next/font in app/layout.tsx, which exposes them as
      // CSS variables. Named here so `font-sans` and `font-mono` resolve to them
      // rather than to the system stack.
      fontFamily: {
